...
def import_missing_daily_lottery():
    """
    Import missing Daily Lottery draws from spreadsheet text data
    """
    with app.app_context():
        print('--- Importing Missing Daily Lottery Draws ---')
        ...
        for draw_data in MISSING_DRAWS:
            ...
            numbers_str = ','.join(str(num) for num in draw_data["numbers"])
            ...
            new_draw = LotteryResult(
                ...
                divisions=json.dumps(draw_data["divisions"]),
                created_at=datetime.now(),
                division_descriptions=json.dumps({
                    "Division 1": "5 Correct Numbers",
                    "Division 2": "4 Correct Numbers",
                    "Division 3": "3 Correct Numbers",
                    "Division 4": "2 Correct Numbers",
                })
            )
