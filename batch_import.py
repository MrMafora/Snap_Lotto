"""
Batch import script that runs with Flask app context
"""
...
if __name__ == "__main__":
    ...
    if not import_file:
        logger.error("Please provide a file path to import")
        sys.exit(1)
    ...
    with app.app_context():
        logger.info(f"Starting import of {import_file} with Flask app context")
        result = import_snap_lotto_data(import_file, flask_app=app)
