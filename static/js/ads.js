...
window.AdManager = {
    ...
    hideLoadingAd: function() {
        ...
        if (adOverlayLoading) {
            ...
            console.log('Loading overlay is now hidden');
        } else {
            console.error('Loading overlay element not found when trying to hide it');
        }
        
        // Force restore scrolling on all elements - extra cautious
        ...
        setTimeout(function() {
            ...
            const checkOverlay = document.getElementById('ad-overlay-loading');
            if (checkOverlay) {
