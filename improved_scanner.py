"""
Improved lottery ticket scanner application that demonstrates the functionality
with both Google Gemini and OpenAI API keys.
"""
...
def scan_ticket():
    ...
    try:
        ...
        # For demo purposes using a simulated result (to avoid API charges):
...
if __name__ == '__main__':
    # Use port 5000 which is the standard Flask port
    port = int(os.environ.get('PORT', 5000))
    logger.info(f"Starting improved scanner on port {port}")
