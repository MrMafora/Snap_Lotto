"""
Capture 12 Screenshots directly from lottery websites

This focused script uses requests with specific headers to capture
the 12 requested lottery screenshots. It saves them as HTML files
...
def capture_all_screenshots():
    """Capture all screenshots from the specified URLs"""
    results = {}
    ...
    for lottery in LOTTERY_URLS:
        ...
        success, filepath, error_message = capture_screenshot(url, lottery_type)
...
if __name__ == "__main__":
    print("Starting capture of 12 lottery screenshots...")
